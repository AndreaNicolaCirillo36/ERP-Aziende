            ...
            <div
                ...
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 flex flex-col items-center"
                    ...
                    <div class="gap-4 flex flex-col items-center">
                        ...
                        <h1 class="text-surface-900 dark:text-surface-0 font-bold text-5xl mb-2">Errore</h1>
                        <span class="text-muted-color mb-8">Si &egrave; verificato un errore.</span>
                        <img src="/demo/images/error/asset-error.svg" alt="Error" class="mb-8" width="80%" />
                        <div class="col-span-12 mt-8 text-center">
                            <Button as="router-link" label="Vai alla Home" to="/" severity="danger" />
                        </div>
                    </div>
                </div>
            </div>
